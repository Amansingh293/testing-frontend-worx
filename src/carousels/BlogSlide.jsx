        ...
        <CarouselContent className="flex ml-28 h-full">
          {blogs.map((blog, idx) => (
            ...
            >
              <Card
                onClick={handleClick}
                className="mt-5 mb-5 ml-3 mr-3  w-auto  p-2 bg-white flex flex-col items-start cursor-pointer rounded-[10px] hover:shadow-[0_6px_16px_0_rgba(0,0,0,0.15)] transition duration-300 overflow-visible"
              >
                <img
                  src={blog.image}
                  alt={blog.title}
