...
const Features = () => {
  ...
  return (
    <>
      <div className="relative w-[1200px] py-10 px-6 lg:px-20 mb-[188px]">
        {/* <div className="absolute  top-[700px] -left-[150px] w-[240px] h-[260px] inset-0 rounded-full bg-[conic-gradient(from_90deg_at_50%_50%,#207C97_0deg,#E6F9FF_360deg)] blur-[80px] -z-10"></div>
      <div className="absolute top-[200px] right-[0px] w-[100px] h-[260px]  rounded-full bg-[conic-gradient(from_90deg_at_50%_50%,#207C97_0deg,#E6F9FF_360deg)] blur-[80px] -z-10"></div> */}
        {/* Header Section */}
        <div className="text-center">
          ...
          <h1 className="text-[#252B37] text-center font-inter text-[36px] font-semibold leading-[44px] tracking-[-0.72px]">
            ...
            <span className="text-[var(--Brand-colour,#207C97)] font-inter text-[36px] font-semibold leading-[44px] tracking-[-0.72px]">Salesworx</span>
          </h1>
          <p className="text-[#414651] font-inter text-[16px] font-normal leading-[24px] mt-[16px]">
            Empowering modern sales teams with AI-driven automation, intelligence, and hyper-personalization.
          </p>
          <Link to="/login">
          <button
        onClick={handleClick}
      ...
      >
        ...
        <div className="mt-[188px] flex flex-col">
